...
void library::about()
{
  ...
  textattr(919);
  gotoxy(10,7) ;textcolor(4);cprintf("This L.I.S. Package has beendesigned to maintain computerised ");
  gotoxy(10,8) ;textcolor(2);cprintf("Library work very easily by alibrarian. It can run under DOS/ ");
  gotoxy(10,9) ;textcolor(5);cprintf("Windows Environment.");

gotoxy(10,10);textcolor(3);cprintf("............................................................. ");
  gotoxy(10,11);textcolor(6);cprintf("Krishna Bihari                     ");
